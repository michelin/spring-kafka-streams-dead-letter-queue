...
public class KafkaStreamsApp {
    ...
    /**
     * Sets a dead letter destination resolver for all recovery exception handlers.
     *
    ...
    public KafkaStreamsDeadLetterDestinationResolver resolver() {
        return (context, record, exception) -> {
            ...
            if (context.processorNodeId().equals("filter-tires-processor")) {
                return new TopicPartition("filter-processor-dlq-topic", -1);
            }
