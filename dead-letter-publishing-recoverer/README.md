...
This module demonstrates how to use the `DeadLetterPublishingRecoverer` to define a dead letter topic for records that fail processing.
...
- Kafka Broker
- Control Center
- Kafka Streams Dead Letter Publishing Recoverer
